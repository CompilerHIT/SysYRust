...
use std::collections::{HashSet, HashMap};
    ...
    impl Graph {
        ...
        pub fn countMaxNodeCostPath(&mut self,from:i32,ends:HashSet<i32>)->i32 {
            // TODO
            let out=self.nodes.len()*10000;
    ...
    pub struct Node {
        pub id:i32, //节点的id
        pub v:i32,  //节点的价值
        pub inedges:Vec<ObjPtr<Edge>>,
        pub outedges:Vec<ObjPtr<Edge>>
    }

    pub struct Edge {
        pub v:i32,  //边的价值
        pub from:ObjPtr<Node>,
        pub to:ObjPtr<Node>
    }
